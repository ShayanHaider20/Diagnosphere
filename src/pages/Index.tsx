  ...
  const features = [
    {
      ...
      description: "Our advanced AI algorithms analyze skin images with high precision to identify potential skin conditions.",
    },
    {
      icon: <Brain className="w-12 h-12 text-diagnosphere-primary" />,
      title: "Machine Learning",
      description: "The system continually learns and improves with each diagnosis, increasing its accuracy over time.",
    },
    {
      icon: <Microscope className="w-12 h-12 text-diagnosphere-primary" />,
      title: "Detailed Analysis",
      description: "Get comprehensive information about potential skin conditions and recommended next steps.",
    },
  ];
    ...
    <div className="min-h-screen flex flex-col">
      ...
      >
        <div className="absolute inset-0 overflow-hidden">
          ...
          <img 
            src="/lovable-uploads/4122e630-800f-4db0-9668-12eb347e6694.png"
            alt="Hero background" 
        ...
        <div className="container mx-auto px-6 relative z-20 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            ...
            >
              Creativity drives this project, combining AI with healthcare to enhance diagnostic accuracy. Our machine learning models continuously evolve, improving with data and iterations. The goal is to push the boundaries of automated skin disease detection, constantly refining the model to provide better, more reliable results for healthcare professionals.
            </motion.p>
      ...
      <section className="py-20 bg-black">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            >
              Our technology combines computer vision with dermatological expertise to provide accurate assessments
            </motion.p>
          </div>
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-gray-300 text-lg mb-8">
              Upload a photo of your skin concern and get an instant assessment powered by our advanced AI technology.
            </p>
            <Link to="/skin-check">
              <Button size="lg" className="bg-diagnosphere-primary hover:bg-diagnosphere-primary/90 text-white text-lg px-8 py-6 h-auto">
